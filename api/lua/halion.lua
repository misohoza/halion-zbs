return {
  ...
  BypassMask = {
      type = "value",
      description = "Enumerator to determine the values that configure if a bus or effect follows the global inserts and Aux bypass buttons of the plug-in.",
      childs = {
...
The default format is 0.]],
          ...
          signature = {
              type = "value",
              description = [[The time signature of the MIDI file as a table. Numerator and denominator are separate fields of that table]],
              childs = {
                  -- Signature Table
          ...
          tracks = {
              type = "value",
              description = [[The tracks of the MIDI file as an array with the index starting at 1. Name, channel and event are separate fields of that table
...
.events	The events of the track as an array with the index starting at 1. The events are stored as Event objects.	(table)]],
      ...
      childs = {
          open ={
              ...
              childs = {
                  ...
                  rate = {
                      type = "value",
                      description = "The sample rate of the audio file. Returns nil if the audio file could not be opened or is invalid."
                  },
                  bits = {
                      type = "value",
                      description = "The bit depth of the audio file. Returns nil if the audio file could not be opened or is invalid."
                  },
                  channels = {
                      type = "value",
                      description = "The number of channels of the audio file. Returns nil if the audio file could not be opened or is invalid."
                  },
                  length = {
                      type = "value",
                      description = "The number of samples in the audio file. Returns nil if the audio file could not be opened or is invalid."
                  },
                  rootKey = {
                      type = "value",
                      description = "The root key stored in the sampler chunk of the audio file. Returns nil if the audio file does not contain an appropriate sampler chunk or could not be opened or is invalid."
                  },
                  keyLow = {
                      type = "value",
                      description = "The lowest key of the key range stored in the sampler chunk of the audio file. Returns nil if the audio file does not contain an appropriate sampler chunk or could not be opened or is invalid."
                  },
                  keyHigh = {
                      type = "value",
                      description = "The highest key of the key range stored in the sampler chunk of the audio file. Returns nil if the audio file does not contain an appropriate sampler chunk or could not be opened or is invalid."
                  },
                  velLow = {
                      type = "value",
                      description = "The lowest velocity of the velocity range stored in the sampler chunk of the audio file. Returns nil if the audio file does not contain an appropriate sampler chunk or could not be opened or is invalid."
                  },
                  velHigh = {
                      type = "value",
                      description = "The highest velocity of the velocity range stored in the sampler chunk of the audio file. Returns nil if the audio file does not contain an appropriate sampler chunk or could not be opened or is invalid."
                  },
                  detune = {
                      type = "value",
                      description = "The tune offset in cents stored in the sampler chunk of the audio file. Returns nil if the audio file does not contain an appropriate sampler chunk or could not be opened or is invalid."
                  },
                  level = {
                      type = "value",
                      description = "The level offset in dB stored in the sampler chunk of the audio file. Returns nil if the audio file does not contain an appropriate sampler chunk or could not be opened or is invalid."
                  },
                  tempo = {
                      type = "value",
                      description = "The tempo in bpm stored in a data chunk of the audio file. Returns nil if the audio file does not contain an appropriate data chunk or could not be opened or is invalid."
                  },
                  beats = {
                      type = "value",
                      description = "The number of beats stored in a data chunk of the audio file. Returns nil if the audio file does not contain an appropriate data chunk or could not be opened or is invalid."
                  },
                  signature = {
                      type = "value",
                      description = "A pair of values for the numerator and denominator of the signature stored in a data chunk of the audio file. The values are nil if the audio file does not contain an appropriate data chunk or could not be opened or is invalid."
                  },
                  sampleStart = {
                      type = "value",
                      description = "The position of the sample start in samples stored in a data chunk of the audio file. Returns nil if the audio file does not contain an appropriate data chunk or could not be opened or is invalid."
                  },
                  sampleEnd = {
                      type = "value",
                      description = "The position of the sample end in samples stored in a data chunk of the audio file. Returns nil if the audio file does not contain an appropriate data chunk or could not be opened or is invalid."
                  },
                  loops = {
                      type = "value",
                      description = "The loop start and end positions in samples stored in a data chunk of the audio file. The returned table is an array that contains tables with the fields loopStart and loopEnd for each loop. Returns nil if the audio file does not contain an appropriate data chunk or could not be opened or is invalid."
                  },
              },
          },
      },
  ...
  Element = {
      type = "class",
      description = "The Element class is the base class for the classes Bus, Instance, Layer, Effect, MidiModule, ModulationMatrixRow, Slot and Zone.",
      childs = {
  ...
  onDropGetInfo = {
      type = "function",
      description = "Callback for the drag source when the drag is started. The text in draginfo is taken from the properties.",
  ...
  onIdle = {
      type = "function",
      description = "This callback function is called periodically if the script is idle. Use this to monitor the progress of load operations, for example.",
      args = "()",
      returns = "()"
  },
  onInit = {
  ...
  onTemplateListViewDrop = {
      type = "function",
      description = "Simplified callback for just reordering items inside a list. If implemented the drag feedback is done automatically. The callback is called if the drop is done to do the reordering operation.",
