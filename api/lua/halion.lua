return {
  ...
  ModulationDestination = {
    ...
    childs = {
      ...
      fmOp1Level = { type = "value" },
      fmOp2Level = { type = "value" },
      fmOp3Level = { type = "value" },
      fmOp4Level = { type = "value" },
      fmOp5Level = { type = "value" },
      fmOp6Level = { type = "value" },
      fmOp7Level = { type = "value" },
      fmOp8Level = { type = "value" },
      fmOp1Pitch = { type = "value" },
      fmOp2Pitch = { type = "value" },
      fmOp3Pitch = { type = "value" },
      fmOp4Pitch = { type = "value" },
      fmOp5Pitch = { type = "value" },
      fmOp6Pitch = { type = "value" },
      fmOp7Pitch = { type = "value" },
      fmOp8Pitch = { type = "value" },
      fmOp1TimeScale = { type = "value" },
      fmOp2TimeScale = { type = "value" },
      fmOp3TimeScale = { type = "value" },
      fmOp4TimeScale = { type = "value" },
      fmOp5TimeScale = { type = "value" },
      fmOp6TimeScale = { type = "value" },
      fmOp7TimeScale = { type = "value" },
      fmOp8TimeScale = { type = "value" },
      fmFeedback = { type = "value" },
      fmModuatorLevel = { type = "value" },
      fmModulatorTimeScale = { type = "value" },
      fmCarrierTimeScale = { type = "value" },
      spectralUnisonVoices = { type = "value" },
      spectralUnisonDetune = { type = "value" },
      spectralUnisonPan = { type = "value" },
      spectralUnisonSpread = { type = "value" },
      spectralPos = { type = "value" },
      spectralDir = { type = "value" },
      spectralSpeed = { type = "value" },
      spectralTargetSpeed = { type = "value" },
      spectralAcceleration = { type = "value" },
      spectralLevel = { type = "value" },
      spectralPurity = { type = "value" },
      spectralInharmonicity = { type = "value" },
      spectralFormantShift = { type = "value" },
      spectralFormantScale = { type = "value" },
      spectralFilterShift = { type = "value" },
      spectralFilterScale = { type = "value" },
      spectralLowCutAmount = { type = "value" },
    },
  },
  NoteExpressionType = {
    type = "value",
